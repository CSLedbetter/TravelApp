(function () {
        ...
        travelCtrl.$inject = ['travelFactory', 'NgMap'];

        function travelCtrl(travelFactory, NgMap) {
            var vm = this;
            vm.show = false;
            vm.info = false;
            vm.restInfo = false;
            ...
            function getArrivalCityName(arrivalCityCode) {
                ...
                travelFactory
                    ...
                    .then(function (arrivalAirportInfo) {
                        ...
                        if (vm.arrivalAvgDelay == "") {
                            vm.arrivalAvgDelay = "None"
                        }
                        vm.arrivalClosure = arrivalAirportInfo.data.status.closureBegin;
                        if (vm.arrivalClosure == "") {
                            vm.arrivalClosure = "None"
                        }
            ...
            function getDepartureCityName(departCityCode) {
                ...
                travelFactory
                    ...
                    .then(function (departAirportInfo) {
                        ...
                        if (vm.departAvgDelay == "") {
                            vm.departAvgDelay = "None"
                        }
                        vm.departClosure = departAirportInfo.data.status.closureBegin;
                        if (vm.departClosure == "") {
                            vm.departClosure = "None"
                        }
            ...
            function getGoogleMap() {
                ...
                NgMap.getMap().then(function (map) {
                    ...
                    map.getBounds().contains(map.marker.getPosition());
                });
            }
